...
x_isotherm = np.array([calcV(1, p, T) for p in y_isotherm])

adiabat_const = 1 * calcV(1, 1, T)**K
...
print 'Isothermal transformation heat Q: ', np.trapz(y_isotherm, x_isotherm)

# For adiabatic transformation Q is by definition 0
print 'Adiabat transformation work: 0'
...
print 'Linear transformation work: ', Q
